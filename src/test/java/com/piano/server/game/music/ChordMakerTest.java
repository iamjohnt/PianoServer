...
public class ChordMakerTest {
    ...
    void test_create_note() {
        maker = new ChordMaker(mode, ChordPattern.NOTE);
    ...
    void test_create_triads() {
        ...
        maker = new ChordMaker(mode, ChordPattern.TRIAD_SUS_4);
        Chord expected = new Chord(60, 65, 67);
        Chord actual = maker.createChord(60);
        assertEquals(expected, actual);

        maker = new ChordMaker(mode, ChordPattern.TRIAD_INVERSION_2_DOWN);
        ...
        maker = new ChordMaker(mode, ChordPattern.TRIAD_INVERSION_2_UP);
        ...
        maker = new ChordMaker(mode, ChordPattern.TRIAD_INVERSION_3_DOWN);
        ...
        maker = new ChordMaker(mode, ChordPattern.TRIAD_INVERSION_3_UP);
    ...
    void test_create_tetrad_seventh() {
        ...
        maker = new ChordMaker(mode,ChordPattern.TETRAD);
        Chord expected = new Chord(60, 64, 67, 72);
        Chord actual = maker.createChord(60);
        assertEquals(expected, actual);

        maker = new ChordMaker(mode,ChordPattern.TETRAD_SEVENTH);
        ...
        maker = new ChordMaker(mode,ChordPattern.TETRAD_INVERTED);
